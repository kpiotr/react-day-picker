  ...
  _createClass(DayPicker, [{
    ...
    value: function renderMonths() {
      var _props3 = this.props,
          ...
          props = _objectWithoutProperties(_props3, ['toMonth', 'modifiers']);

      var months = [];
      var firstDayOfWeek = Helpers.getFirstDayOfWeekFromProps(this.props);
      for (var i = 0; i < this.props.numberOfMonths; i += 1) {
        var month = DateUtils.addMonths(this.state.currentMonth, i);
        months.push(_react2.default.createElement(_Month2.default, _extends({}, props, {
          month: month.getTime(),
...
var Month = function (_PureComponent) {
  ...
  function Month() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Month.__proto__ || Object.getPrototypeOf(Month)).call.apply(_ref, [this].concat(args))), _this), _this.renderDay = function (day) {
      var monthNumber = new Date(_this.props.month).getMonth();
    ...
    value: function render() {
      ...
      var captionProps = {
        ...
        onClick: onCaptionClick ? function (e) {
          return onCaptionClick(monthDate, e);
        } : undefined
      };
      var caption = _react2.default.isValidElement(captionElement) ? _react2.default.cloneElement(captionElement, captionProps) : _react2.default.createElement(captionElement, captionProps);

      var weeks = Helpers.getWeekArray(monthDate, firstDayOfWeek, fixedWeeks);
      return _react2.default.createElement(
        'div',
          ...
          weeks.map(function (week) {
            ...
            return _react2.default.createElement(
              ...
              showWeekNumbers && _react2.default.createElement(
                ...
                _this2.props.renderWeek(weekNumber, week, monthDate)
              ),
...
Month.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  captionElement: _propTypes2.default.oneOfType([_propTypes2.default.element, _propTypes2.default.func, _propTypes2.default.instanceOf(_react2.default.PureComponent)]).isRequired,
  weekdayElement: _propTypes2.default.oneOfType([_propTypes2.default.element, _propTypes2.default.func, _propTypes2.default.instanceOf(_react2.default.PureComponent)]),
  ...
  _createClass(Day, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          dateAsString = _props.dateAsString;
...
Day.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  onFocus: _propTypes2.default.func,
  tabIndex: _propTypes2.default.number,
  dateAsString: _propTypes2.default.string
} : {};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
